...
|---------|------|------|-------------|-----------|-------------------|-------------|--------|
| 43-01-01 | 01 | 0 | — | unit | `pytest bridge/tests/test_scanner.py -x` | ❌ W0 | ⬜ pending |
| 43-01-02 | 01 | 0 | — | unit | `pytest bridge/tests/test_mdns_advertise.py -x` | ❌ W0 | ⬜ pending |
| 43-01-03 | 01 | 0 | — | unit | `pytest bridge/tests/test_command_queue.py -x` | ❌ W0 | ⬜ pending |
| 43-01-04 | 01 | 0 | — | unit | `pytest bridge/tests/test_dedup.py -x` | ❌ W0 | ⬜ pending |
| 43-01-05 | 01 | 0 | — | unit | `pytest robot/tests/test_mdns_fallback.py -x` | ❌ W0 | ⬜ pending |
| 43-01-06 | 01 | 0 | — | unit | `pytest bridge/tests/test_bridge_relay.py -x` | ❌ W0 | ⬜ pending |
| 43-02-01 | 02 | 1 | — | unit (mock) | `pytest bridge/tests/test_scanner.py::test_mdns_browse -x` | ❌ W0 | ⬜ pending |
| 43-02-02 | 02 | 1 | — | unit (mock) | `pytest bridge/tests/test_scanner.py::test_ssdp_scan -x` | ❌ W0 | ⬜ pending |
| 43-03-01 | 03 | 1 | — | unit | `pytest robot/tests/test_mdns_fallback.py -x` | ❌ W0 | ⬜ pending |
| 43-04-01 | 04 | 2 | — | integration | `pytest bridge/tests/test_bridge_relay.py -x` | ❌ W0 | ⬜ pending |
...
- [ ] `bridge/tests/__init__.py` — bridge test package
