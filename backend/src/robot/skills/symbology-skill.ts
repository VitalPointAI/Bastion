...
const KNOWN_VEHICLES: Record<string, VehicleEntry> = {
  // PLA vehicles
  't-90':    { designation: 'T-90 Main Battle Tank',              affiliation: 'hostile', symbolSet: '15', entity: '120100', category: 'mbt',  notes: 'Russian MBT, composite + Kontakt-5 ERA' },
  't90':     { designation: 'T-90 Main Battle Tank',              affiliation: 'hostile', symbolSet: '15', entity: '120100', category: 'mbt',  notes: 'Russian MBT' },
  'chn-99g': { designation: 'Type 99G Main Battle Tank (ZTZ-99G)',affiliation: 'hostile', symbolSet: '15', entity: '120100', category: 'mbt',  notes: 'PLA advanced MBT, FY-4 ERA + APS' },
  'chn99g':  { designation: 'Type 99G Main Battle Tank (ZTZ-99G)',affiliation: 'hostile', symbolSet: '15', entity: '120100', category: 'mbt',  notes: 'PLA advanced MBT' },
  't72':     { designation: 'T-72 Main Battle Tank',              affiliation: 'hostile', symbolSet: '15', entity: '120100', category: 'mbt',  notes: 'Russian MBT, widely exported' },
  'ztz99':   { designation: 'ZTZ-99 Main Battle Tank',            affiliation: 'hostile', symbolSet: '15', entity: '120100', category: 'mbt',  notes: 'PLA MBT' },
  'type99':  { designation: 'Type 99 Main Battle Tank',           affiliation: 'hostile', symbolSet: '15', entity: '120100', category: 'mbt',  notes: 'PLA MBT' },
  't-99':    { designation: 'Type 99 Main Battle Tank',           affiliation: 'hostile', symbolSet: '15', entity: '120100', category: 'mbt',  notes: 'PLA MBT' },
  ...
  // Friendly
  'm1':      { designation: 'M1 Abrams Main Battle Tank',         affiliation: 'friendly',symbolSet: '15', entity: '120100', category: 'mbt',  notes: 'US MBT' },
  ...
  // Generic
  'tank':            { designation: 'Unknown Tank',                affiliation: 'hostile', symbolSet: '15', entity: '120100', category: 'mbt',     notes: 'Generic tank detection' },
