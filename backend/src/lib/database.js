...
exports.dualWriteDocument = dualWriteDocument;
 ...
 */
function dualWriteDocument(doc) {
    return __awaiter(this, void 0, void 0, function () {
        var client, docResult, documentId, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getPool().connect()];
                case 1:
                    client = _a.sent();
                    _a.label = 2;
                case 2:
...
function getDocument(documentId) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getPool().query("\n    SELECT * FROM documents WHERE document_id = $1\n  ", [documentId])];
                case 1:
                    result = _a.sent();
 ...
 */
function listUserDocuments(ownerAccountId_1) {
    return __awaiter(this, arguments, void 0, function (ownerAccountId, limit, offset) {
        var result;
