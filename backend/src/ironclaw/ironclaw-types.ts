...
// ---------------------------------------------------------------------------
// Agent Config — Per-User Identity & Personality (Phase 60 Plan 03)
// ---------------------------------------------------------------------------

/**
 * Staff section designation. Drives SOUL.md personality template selection.
 * NOTE: Per blueprint, clearance level is NEVER stored here — it is always
 * read from VC claims at runtime.
 */
