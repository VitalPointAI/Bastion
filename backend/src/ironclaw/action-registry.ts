...
const CANONICAL_DESCRIPTIONS: Record<string, string> = {
  'bastion_problem_set_read': 'Read problem set details and configuration',
  'bastion_problem_set_list_children': 'List child problem sets',
  'bastion_problem_set_update_field': 'Update a field on a problem set',
  'bastion_problem_set_create_child': 'Create a new child problem set',
  'bastion_problem_set_configure_agents': 'Configure AI agents for a problem set (HIGH RISK)',
  'bastion_resource_create': 'Create a resource in the registry',
  'bastion_resource_delete': 'Delete a resource from the registry (HIGH RISK)',
  'bastion_gate_create': 'Create a decision gate for approval workflow',
  'bastion_code_create_pr': 'Create a GitHub PR with code changes (HIGH RISK)',
  'bastion_system_update_config': 'Update system-level configuration (HIGH RISK)',
  ...
  // Design synthesis
  'bastion_design_synthesize_current_state': 'Synthesize Current State assessment from knowledge graph data',
  // Map overlay tools
  'bastion_design_map_add_symbol': 'Add a military symbol to the operational approach map',
  'bastion_design_map_move_symbol': 'Move a map symbol to a new position',
  'bastion_design_map_remove_symbol': 'Remove a symbol from the map',
  'bastion_design_map_update_symbol': 'Update properties of a map symbol',
  'bastion_design_map_add_control_measure': 'Add a control measure to the map',
  'bastion_design_map_add_overlay_graphic': 'Add an annotation graphic to the map',
  // Knowledge graph (read-only)
  'bastion_graph_search_actors': 'Search the knowledge graph for actors by name or type',
  'bastion_graph_get_actor': 'Get full details of a specific actor node with relationships',
  'bastion_graph_query': 'Run a read-only Cypher query against the knowledge graph',
  'bastion_graph_stats': 'Get knowledge graph statistics (node counts, top actors)',
