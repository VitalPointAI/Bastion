...
var edge_sync_1 = require("./api/edge-sync");
var accounts_1 = require("./api/accounts");
var identity_1 = require("./api/identity");
var blockchain_sync_1 = require("./lib/blockchain-sync");
...
app.use('/api/edge', edge_sync_1.default);
...
app.listen(port, function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, (0, blockchain_sync_1.startSyncWorkers)()];
            case 2:
                _a.sent();
                return [3 /*break*/, 4];
            case 3:
                error_1 = _a.sent();
                console.error('Failed to start sync workers:', error_1);
                return [3 /*break*/, 4];
