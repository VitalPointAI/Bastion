...
export function ProblemFramingSection({ problemSetId: _problemSetId, initialData, onUpdate }: ProblemFramingSectionProps) {
  ...
  return (
    <div className="flex flex-1 min-h-0 overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto p-4">
        {/* Header with save status and Ironclaw button */}
        <div className="flex items-center justify-between mb-4">
          ...
          <button
            onClick={() => {
              sendMessage("Analyze: " + JSON.stringify(formData));
              toggleDrawer();
            }}
