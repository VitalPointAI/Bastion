 ...
 * MDMPStepLayout
 *
 * Phase 34 Plan 02: Shared layout wrapper for MDMP step components.
 * Mirrors JPPStepLayout pattern with step header, AI agent panel,
 * governance gates, and step-specific content.
 */

import { useState, type ReactNode } from 'react';
import type { MDMPStepId } from './MDMPStepConfig.ts';
...
export interface MDMPStepLayoutProps {
  stepId: MDMPStepId;
  stepLabel: string;
  stepNumber: number;
  problemSetId: string;
...
export function MDMPStepLayout({
  stepId,
  stepLabel,
  stepNumber,
      ...
      >
        ...
        {aiPanelExpanded && (
          <div style={{ marginTop: '0.5rem', fontSize: '0.8rem', color: '#9ca3af' }}>
            ...
            <p style={{ margin: '0 0 0.5rem' }}>
              Workflow: <span style={{ color: '#d1d5db' }}>{workflowId.slice(0, 8)}...</span>
            </p>
            <button
              style={{
