 ...
 *
 * Phase 42 Plan 04: Moved from cop/ to resources/network/. Added onNodeClick
 * callback prop for cross-view selection (locked decision per 42-CONTEXT.md).
 */
...
export function NetworkTopologyView({
  ...
  const handleNodeClick = useCallback(
    async (nodeId: string) => {
      ...
      // Invoke external callback to set selected resource in context
      onNodeClick?.(nodeId);
      try {
