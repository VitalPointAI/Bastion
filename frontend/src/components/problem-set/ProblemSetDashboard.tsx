...
export function ProblemSetDashboard() {
  ...
  if (resolvedId && !loading && memberships.length > 0 && !isMember) {
    return (
      <div className="flex flex-col items-center justify-center min-h-64 p-8 text-center">
        ...
        <p className="text-sm text-gray-500">You are not a member of this problemSet.</p>
      </div>
    );
  }
  ...
  // Decision items from cross-problem set updates
  const decisionItems = crossProblemSetUpdates.filter(
          ...
          <div className="flex flex-col h-full min-h-0">
            ...
            <div className="flex-1 overflow-y-auto p-3">
              {activeFeed === 'activity' && displayId && (
                <ActivityFeed problemSetId={displayId} userRole={userRoleInActive} limit={15} />
              )}
              {activeFeed === 'decisions' && (
                        ...
                        <div className="flex items-start gap-2">
                          ...
                          <div className="min-w-0">
                            ...
                            <p className="text-[10px] text-gray-500 mt-1">
                              from {item.sourceProblemSetName}
                              {' · '}
