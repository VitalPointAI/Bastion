...
const ROLE_META: Record<string, RoleMeta> = {
  ...
  team_lead: {
    label: 'Team Lead',
    description: 'Leads a specialized team within this workspace.',
    color: 'text-indigo-400',
  },
  member: {
    label: 'Member',
    description: 'Contributing member of this workspace.',
    color: 'text-gray-300',
  },
};
...
const DEFAULT_ROLE_META: RoleMeta = {
  label: 'Staff Member',
  description: 'Staff role within this workspace.',
  color: 'text-gray-300',
};
